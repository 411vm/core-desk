...
const Login = () => {
  ...
  const mockCredentials = {
    operator: { username: 'operador', password: '123456', role: 'operator' },
    manager: { username: 'gestor', password: '123456', role: 'manager' }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-slate-600">Área dos Operadores de TI</p>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200">
            <div className="text-sm text-slate-600 space-y-2">
              ...
              <div className="bg-slate-50 p-3 rounded-md space-y-1">
                <p><strong>Operador:</strong> operador / 123456</p>
                <p><strong>Gestor:</strong> gestor / 123456</p>
              </div>
            </div>
          </div>
        </CardContent>
