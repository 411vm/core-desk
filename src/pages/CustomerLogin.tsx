...
const CustomerLogin = () => {
  ...
  // Mock credentials for customers
  const mockCredentials = {
    customer1: { username: 'cliente1', password: '123456', role: 'customer' },
    customer2: { username: 'cliente2', password: '123456', role: 'customer' }
  };
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (credential) {
      ...
      localStorage.setItem('coredesk_customer', JSON.stringify({
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-slate-600">Central de atendimento do cliente</p>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200">
            <div className="text-sm text-slate-600 space-y-2">
              ...
              <div className="bg-slate-50 p-3 rounded-md space-y-1">
                <p><strong>Cliente 1:</strong> cliente1 / 123456</p>
                <p><strong>Cliente 2:</strong> cliente2 / 123456</p>
              </div>
            </div>
          </div>
        </CardContent>
